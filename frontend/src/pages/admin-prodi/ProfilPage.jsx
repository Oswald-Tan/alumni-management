...
export default function ProfilPage() {
  ...
  useEffect(() => {
    getProfile()
      ...
      .catch(() => {
        toast.error("Gagal memuat profil admin prodi");
      })
      .finally(() => {
        setIsLoading(false);
      });
    ...
    <div className="p-8">
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Kelola foto profil dan informasi akun admin program studi Anda</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl">
        ...
        <div className="card shadow-md border border-slate-100 p-8">
          ...
          <div className="space-y-6">
            <h3 className="text-base font-bold text-slate-800 border-l-4 border-emerald-600 pl-3">Informasi Akun</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100 sm:col-span-2">
                ...
                <div>
                  <p className="text-xs text-slate-400 font-semibold uppercase">Program Studi Terikat</p>
                  <p className="text-sm font-semibold text-slate-800 mt-0.5">
                    {adminDetail?.jurusan ? `${adminDetail.jurusan.namaJurusan} / ${adminDetail.jurusan.namaProdi}` : "Semua Prodi"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100 sm:col-span-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-slate-800 mt-0.5">Admin Prodi (Akses Terbatas)</p>
                </div>
              </div>
            </div>
          </div>
